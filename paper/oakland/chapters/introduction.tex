...
Do we need to do a comprehesive check after a loop.

16~1024 power of two
...
Object & object access (fileds access)
Optimization times
...
So memory buffers. So we create redzone inside a buffer.
So the bigger object.
If there are initernal buffer overflow, we



For object, we just need to check the start address once.
