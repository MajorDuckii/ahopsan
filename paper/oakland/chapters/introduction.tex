...
\begin{algorithm}
  ...
  \begin{algorithmic}[1]
    ...
    \Function{CollectMemAccess}{$I$} \Comment{CollecRes $:\rightarrow$ CollectMemAccess}
...
\begin{algorithm}
  ...
  \begin{algorithmic}[1]
    ...
    \Function{AnalysisAccessSemantic}{$C$}
    \State $MAC$ = $\emptyset$
    \For{$e$ in C}
    \If {e.type is $Instruction$}
    \State MAC.append(e)
    \ElsIf {e.type is $Scope$}
